...
#Listing12.2 #########BasicLin&KernighanimprovementprocedurefortheTSP
def tsp_LK(D, tour, length): #Distancematrix # Solution # Tour length
    n = len(tour)
    ...
    while a != last_a or improved:
        ...
        while path_modified: # Identify best ref. struct. with edge a-b removed 
            ...
            while succ[c] != a: # Ejection can be propagated
                ...
                if tabu[c][d] != iteration and path_length + D[b][d] < ref_struct_cost:
